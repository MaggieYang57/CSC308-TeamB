...
export function Ratings({ rating }) {
	...
	return (
		<div>
	        ...
	        <a> <Image src={getStar(rating, 0)} style={{height: '2rem', width: '2.1rem', borderRadius: 0}}fluid /> </a>
	        <a style={{marginLeft: '.3vw'}} > <Image src={getStar(rating, 1)} style={{height: '2rem', width: '2.1rem', borderRadius: 0}}fluid /> </a>
	        <a style={{marginLeft: '.3vw'}} > <Image src={getStar(rating, 2)} style={{height: '2rem', width: '2.1rem', borderRadius: 0}}fluid /> </a>
	        <a style={{marginLeft: '.3vw'}} > <Image src={getStar(rating, 3)} style={{height: '2rem', width: '2.1rem', borderRadius: 0}}fluid /> </a>
	        <a style={{marginLeft: '.3vw'}} > <Image src={getStar(rating, 4)} style={{height: '2rem', width: '2.1rem', borderRadius: 0}}fluid /> </a>
