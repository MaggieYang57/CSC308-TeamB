      ...
      <div className="home">
         <div className="top-banner">
            <div className="banner-info">
               ...
               <div>
                  <b className="text text-center " style={{ fontSize: 35, color: "#2C6674", marginLeft: "2vw" }}>Want to get out and explore?</b>
         ...
         <div className="featured-hikes">
            <div id="featured-title">
               <b className="text text-left" style={{ fontSize: 35, color: "#2C6674", marginLeft: "7vw" }}>Most Popular Hikes<hr /></b>
            </div>
